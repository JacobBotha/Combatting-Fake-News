...
export default function Easy() {
  return(
    <div>
      <h1>{"This Page Doesn't Compile!"}</h1>
    </div>
  );
}

// class SoloQuiz extends React.Component {
//   constructor(props) {
//     super(props);
...
//     var ansarr = [<Answer statement="True" isCorrect={true} answerQuestion={this.updateScore} key={1}/>,
