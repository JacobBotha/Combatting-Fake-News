...
export class Question extends Model {
     ...
     * @param { String } id 
     */
    constructor(headline, questionTypeId, questionType, id = null) {
        super();
        this.idQuestions = id;
...
export async function questionsFromQAJoin(questionJSON) {
    ...
    for (const i of questionJSON) {
        ...
        let question = new Question(i.headline, i.Question_Type_idQuestion_Type, questionType, i[Question.prototype.getIdName()]);
