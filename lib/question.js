...
export class Question extends Model {
     ...
     * @param { String } id 
     */
    constructor(headline, body, hint, questionTypeId, questionType, id = null) {
        super();
        this.idQuestions = id;
        this.body = body;
...
export async function questionsFromQAJoin(questionJSON) {
    ...
    let questionQry =  await new QuestionQuery().select().run();

    console.log(questionQry);
    ...
    for (const i of questionJSON) {
        ...
        let question = new Question(i.headline, i.body, i.hint, i.Question_Type_idQuestion_Type, questionType, i[Question.prototype.getIdName()]);
